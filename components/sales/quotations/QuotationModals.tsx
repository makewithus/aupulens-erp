...
export function QuotationModals({
  ...
  // Child Submitting State (for nested modals creation)
  ...
  // 5. Nested Pricelist Modal (nested from partner/product)
  ...
  // 6. Nested Account Modal (nested from partner/product)
  ...
  // API Call Helpers for nested creations
  ...
  return (
    <>
      {/* Main View/Edit/Create Quotation Modal */}
      <ModularModal
        open={isModalOpen}
      ...
      {/* Nested Account Modal (from Partner/Product popup) */}
      <ModularModal
