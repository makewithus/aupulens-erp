  ...
  return (
    <div className="relative w-full max-w-md" ref={wrapperRef}>
      <div className="relative" onClick={() => setIsOpen(true)}>
        ...
        />
        {query && (
           <X className="w-4 h-4 absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground cursor-pointer" onClick={() => { setQuery(""); setResults([]); }} />
        )}
      </div>
            ...
            <div className="py-2">
              {results.map((r, idx) => (
                <div 
                  ...
                  className="px-4 py-2 hover:bg-accent cursor-pointer flex items-center justify-between group"
                >
                  <div className="flex items-center gap-3">
                    <div className="bg-background p-1.5 rounded">
                       ...
                       <div className="w-4 h-4 text-muted-foreground font-bold flex items-center justify-center text-[10px]">{r.type[0]}</div>
                    </div>
                    <div>
