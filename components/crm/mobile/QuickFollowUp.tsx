...
export default function QuickFollowUp() {
  ...
  return (
    <div className="grid grid-cols-4 gap-2">
      <button onClick={() => handleAction("Call Back")} className="flex flex-col items-center gap-2 p-2 bg-card rounded-lg active:scale-95 transition-transform border border-border">
        ...
        <span className="text-[10px] text-center text-muted-foreground">Call Back</span>
      </button>
      <button onClick={() => handleAction("Send Proposal")} className="flex flex-col items-center gap-2 p-2 bg-card rounded-lg active:scale-95 transition-transform border border-border">
        ...
        <span className="text-[10px] text-center text-muted-foreground">Proposal</span>
      </button>
      <button onClick={() => handleAction("Schedule Demo")} className="flex flex-col items-center gap-2 p-2 bg-card rounded-lg active:scale-95 transition-transform border border-border">
        ...
        <span className="text-[10px] text-center text-muted-foreground">Demo</span>
      </button>
      <button onClick={() => handleAction("Email Follow Up")} className="flex flex-col items-center gap-2 p-2 bg-card rounded-lg active:scale-95 transition-transform border border-border">
