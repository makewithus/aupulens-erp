...
function AuthContent() {
  ...
  const switchToAdmin = () => router.push("/auth/admin");
  const switchToFinance = () => router.push("/auth/finance");
  const switchToInventory = () => router.push("/auth/inventory");
  const switchToSales = () => router.push("/auth/sales");
  const switchToManufacturing = () => router.push("/auth/manufacturing");
              ...
              <div className="relative bg-white dark:bg-gray-900 rounded-none border border-gray-200 dark:border-gray-800 p-12">
                <div className="mb-10">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    Human Resources & Payroll Access
                  </p>
                </div>
                <SignInForm />
              </div>
