  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-neutral-400 mt-1">Track deployment progress, milestones, and implementation delays.</p>
      </div>
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-neutral-800 hover:bg-transparent">
              ...
              <TableHead className="text-neutral-400">Progress</TableHead>
              <TableHead className="text-neutral-400">Next Milestone</TableHead>
              <TableHead className="text-neutral-400">Owner</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {loading ? <TableRow><TableCell colSpan={5} className="text-center py-6 text-neutral-500">Loading...</TableCell></TableRow> : 
             plans.length === 0 ? <TableRow><TableCell colSpan={5} className="text-center py-10 text-neutral-500 border border-dashed border-neutral-800">No active onboardings.</TableCell></TableRow> :
             plans.map(plan => {
               const nextMilestone = plan.milestones.find((m: any) => m.status === "Pending");
               return (
                 <TableRow key={plan._id} className="border-neutral-800 hover:bg-neutral-800/50">
                   ...
                   <TableCell>
                     ...
                     <span className="text-[10px] text-neutral-500 mt-1">{plan.progress}%</span>
                   </TableCell>
                   ...
                   <TableCell className="text-xs text-neutral-400">{plan.owner_id?.name || 'Unassigned'}</TableCell>
                 </TableRow>
               );
             })}
          </TableBody>
