...
import {
  Megaphone, DollarSign, Target, TrendingUp, Users, Activity, ExternalLink
} from "lucide-react";
...
export default function CampaignDetailPage(props: { params: Promise<{ id: string }> }) {
  ...
  if (loading) return <div className="p-6 text-neutral-400">Loading Campaign...</div>;
    ...
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
      ...
      <div className="bg-neutral-900 p-6 rounded-lg border border-neutral-800 flex flex-col gap-4 shadow-sm">
        <div className="flex justify-between items-start">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <Badge variant="outline" className="font-mono text-neutral-400 border-neutral-700 bg-neutral-950">
                {data.campaign_code}
              </Badge>
            </div>
        ...
        {metrics && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
            <div className="p-4 rounded-md border border-neutral-800 bg-neutral-950">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-neutral-900 border border-neutral-800 p-6 rounded-lg space-y-4">
            ...
            {data.notes && (
              <div className="mt-4 pt-4 border-t border-neutral-800">
                <p className="text-neutral-500 mb-1 text-sm">Notes</p>
                <div className="bg-neutral-950 p-3 rounded border border-neutral-800 text-sm whitespace-pre-wrap text-neutral-300">
                  {data.notes}
                </div>
              </div>
            )}
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          {metrics && (
             <div className="bg-neutral-900 border border-neutral-800 p-6 rounded-lg space-y-4">
               <h2 className="text-lg font-bold border-b border-neutral-800 pb-2">Attribution Funnel</h2>
               <div className="space-y-3">
                 <div className="flex justify-between items-center p-2 rounded bg-neutral-950 border border-neutral-800">
                   <div className="flex items-center gap-2 text-sm text-neutral-300"><Users className="w-4 h-4 text-neutral-500"/> Total Leads</div>
                   <div className="font-bold">{metrics.totalLeads}</div>
                 </div>
                 <div className="flex justify-between items-center p-2 rounded bg-neutral-950 border border-neutral-800">
                   <div className="flex items-center gap-2 text-sm text-neutral-300"><Target className="w-4 h-4 text-neutral-500"/> Qualified Leads</div>
                   <div className="font-bold">{metrics.qualifiedLeads}</div>
                 </div>
                 <div className="flex justify-between items-center p-2 rounded bg-neutral-950 border border-neutral-800">
                   <div className="flex items-center gap-2 text-sm text-neutral-300"><Activity className="w-4 h-4 text-yellow-500"/> Opportunities</div>
                   <div className="font-bold">{metrics.totalOpportunities}</div>
                 </div>
                 <div className="flex justify-between items-center p-2 rounded bg-neutral-950 border border-neutral-800">
                   <div className="flex items-center gap-2 text-sm text-neutral-300"><TrendingUp className="w-4 h-4 text-green-500"/> Closed Won</div>
