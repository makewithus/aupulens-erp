    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-neutral-400 text-sm mt-1">Global marketing performance, ROI, and attribution.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Channel Attribution */}
        <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-5 lg:col-span-2 shadow-sm">
          <h2 className="text-lg font-bold flex items-center gap-2 mb-4">
            <Target className="w-5 h-5 text-neutral-400" /> Revenue & Leads by Channel
          </h2>
          {loading ? (
              ...
              <table className="w-full text-sm text-left">
                ...
                <tbody>
                  ...
                  {reports?.channelAttribution?.length === 0 && (
                    <tr><td colSpan={3} className="py-6 text-center text-neutral-500">No attribution data.</td></tr>
                  )}
                </tbody>
              </table>
            </div>
            ...
            {loading ? (
              ...
              <div className="space-y-3">
                {reports.topCampaigns.map((c: any) => (
                  <div key={c._id} className="flex justify-between items-center border-b border-neutral-800 pb-2 last:border-0 last:pb-0">
              ...
              <div className="text-center py-6 text-neutral-500 text-sm">No campaigns to display.</div>
            )}
          </div>
