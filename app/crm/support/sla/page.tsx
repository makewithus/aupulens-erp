  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-neutral-400 mt-1">Track case compliance, average resolution times, and active breaches.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="bg-neutral-900 border-neutral-800">
          <CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-neutral-400">SLA Compliance</CardTitle></CardHeader>
          <CardContent>
            <div className="text-3xl font-bold text-green-400">96.4%</div>
            <p className="text-xs text-neutral-500 mt-1">Target: 95.0%</p>
          </CardContent>
        </Card>
        <Card className="bg-neutral-900 border-neutral-800">
          <CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-neutral-400">Average Resolution Time</CardTitle></CardHeader>
          <CardContent>
      ...
      <div className="bg-neutral-900 border border-neutral-800 p-10 text-center rounded-lg text-neutral-500 border-dashed mt-6">
