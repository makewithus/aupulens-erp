  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div>
        ...
        <p className="text-neutral-400 mt-1">Your personal pipeline and daily tasks.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-5 h-64 flex flex-col justify-center items-center">
          <p className="text-neutral-500 text-sm">Deals at Risk</p>
        </div>
        <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-5 h-64 flex flex-col justify-center items-center">
          <p className="text-neutral-500 text-sm">Forecast vs Quota</p>
        </div>
      </div>
    </div>
  );
