    ...
    >
      <div className="max-w-3xl mx-auto p-6 space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-4xl md:text-[56px] font-black tracking-tighter text-primary">Quotes - Select File</h1>
        ...
        {step === 1 && (
          <div className="space-y-5">
            ...
            <p className="text-xs text-muted-foreground">
              Download a{" "}
              <Link href="/api/sales/quotes/import/sample?format=csv" className="text-primary underline">
                sample csv file
              </Link>{" "}
              or{" "}
              <Link href="/api/sales/quotes/import/sample?format=xls" className="text-primary underline">
                sample xls file
              </Link>{" "}
            ...
            <div className="flex justify-between pt-2">
              <Button variant="outline" className="rounded-none border-border/40 font-mono text-[11px] uppercase tracking-wider" onClick={() => router.push("/sales/quotes")}>
                Cancel
              </Button>
              <Button
          ...
          <div className="space-y-4">
            {result ? (
              <div className="border border-emerald-500/30 rounded-none p-4 bg-card text-sm space-y-1">
                ...
                <Button className="mt-2 font-mono text-[11px] uppercase tracking-wider" onClick={() => router.push("/sales/quotes")}>
                  Done
                </Button>
              </div>
            ) : (
