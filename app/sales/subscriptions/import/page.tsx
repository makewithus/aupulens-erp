    ...
    >
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-bold">Subscriptions - Select File</h1>
        ...
        {step === 1 && (
          <div className="space-y-5">
            ...
            <p className="text-xs text-muted-foreground">
              Download a{" "}
              <Link href="/api/sales/subscriptions/import/sample?format=csv" className="text-blue-600 underline">
                sample file
              </Link>{" "}
          ...
          <div className="space-y-4">
            ...
            {result ? (
              <div className="border rounded-none p-4 bg-green-50 dark:bg-green-950/20 text-sm space-y-1">
                ...
                <Button className="mt-2" onClick={() => router.push("/sales/subscriptions")}>
                  Done
                </Button>
              </div>
            ) : (
