...
// Vocabulary lives in a dependency-free module so client components can import
// it without pulling this file's Node-only AI client into the browser bundle.
import { RULE_TRIGGERS, RULE_ENTITIES, RULE_OPERATORS, RULE_ACTIONS } from "@/lib/crm/automationVocabulary";

// Re-exported for backward compatibility with existing server-side importers.
export { RULE_TRIGGERS, RULE_ENTITIES, RULE_OPERATORS, RULE_ACTIONS };
